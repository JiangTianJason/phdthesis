...
lstm_model = LSTMForClassification(model_path='/root/autodl-tmp/lstm-ag-news')

model = textattack.models.wrappers.PyTorchModelWrapper(lstm_model, lstm_model.tokenizer)
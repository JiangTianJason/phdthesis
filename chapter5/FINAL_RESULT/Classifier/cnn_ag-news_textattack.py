...
cnn_model = WordCNNForClassification(model_path='/root/autodl-tmp/cnn-ag-news')

model = textattack.models.wrappers.PyTorchModelWrapper(cnn_model, cnn_model.tokenizer)
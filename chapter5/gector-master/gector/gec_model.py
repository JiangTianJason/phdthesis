...
class GecBERTModel(object):
    def __init__(self, vocab_path=None, model_paths=None,
                 ...
                 log=False,
                 iterations=3,
                 model_name=r'/root/autodl-tmp/roberta',
    ...
    def get_token_action(self, token, index, prob, sugg_token):
        ...
        if prob < self.min_error_probability or sugg_token in [UNK, PAD, '$KEEP'] or sugg_token.startswith("$MERGE_"):
            return None
        ...
        elif sugg_token.startswith('$TRANSFORM_'):

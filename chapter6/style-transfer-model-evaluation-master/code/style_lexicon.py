...
from utils import invert_dict, load_json, load_train_set, load_model, save_json, save_model
import numpy as np

dataset_name = "sst-2"

DATA_VECTORIZER_PATH = f'../models/vectorizer_{dataset_name}.pkl'
...
x_tr, y_tr = load_train_set(dataset_name)
...
C = 3
lr_path = f'../models/style_weights_extractor_{regularization_type}_reg_C_{C}_{dataset_name}.pkl'
...
style_features_and_weights_path = fr'../style_lexicon/style_words_and_weights_{dataset_name}.json'
